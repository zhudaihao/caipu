...
public class ToastUtils {
    ...
    private static final ToastUtils myToast = new ToastUtils();
    ...
    //旋转加载 居中
    public TextView tv_num, tv_content;
    ...
    public void showToastShape(Context context, String gainCoinNum) {
        ...
        //获取控件
        ll_layout = (LinearLayout) inflate.findViewById(R.id.ll_layout);
    ...
    //居中
    public void shownCentreToast(Context context, String content) {
        Toast toast = Toast.makeText(context, content, Toast.LENGTH_SHORT);
