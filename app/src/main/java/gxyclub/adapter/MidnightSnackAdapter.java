...
public class MidnightSnackAdapter extends BaseQuickAdapter<BreakFastBean, BaseViewHolder> {
    ...
    public MidnightSnackAdapter(List<BreakFastBean> mList, Activity activity) {
