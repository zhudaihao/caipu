...
public class DinnerFastAdapter extends BaseQuickAdapter<BreakFastBean, BaseViewHolder> {
    ...
    public DinnerFastAdapter(List<BreakFastBean> mList, Activity activity) {
