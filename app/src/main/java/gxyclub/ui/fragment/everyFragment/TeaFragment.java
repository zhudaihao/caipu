...
import gxyclub.adapter.TeaAdapter;
...
public class TeaFragment extends BaseRefreshFragment {
    ...
    protected void setBaseRefreshAdapter() {
        ...
        teaAdapter = new TeaAdapter(mList, activity);
        //false动画重复
        teaAdapter.isFirstOnly(false);
        //设置那种动画
        teaAdapter.openLoadAnimation(BaseQuickAdapter.ALPHAIN);

        recyclerView.setAdapter(teaAdapter);

        teaAdapter.setOnItemClickListener(this);
    }
