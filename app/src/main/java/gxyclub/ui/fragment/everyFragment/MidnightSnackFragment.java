...
import gxyclub.adapter.MidnightSnackAdapter;
...
public class MidnightSnackFragment extends BaseRefreshFragment {

    private MidnightSnackAdapter midnightSnackAdapter;
    ...
    protected void setBaseRefreshAdapter() {
        ...
        midnightSnackAdapter = new MidnightSnackAdapter(mList, activity);
        //false动画重复
        midnightSnackAdapter.isFirstOnly(false);
        //设置那种动画
        midnightSnackAdapter.openLoadAnimation(BaseQuickAdapter.ALPHAIN);

        recyclerView.setAdapter(midnightSnackAdapter);

        midnightSnackAdapter.setOnItemClickListener(this);
    }
