...
import gxyclub.adapter.LunchAdapter;
...
public class LunchFragment extends BaseRefreshFragment {
    ...
    protected void setBaseRefreshAdapter() {
        ...
        lunchAdapter = new LunchAdapter(mList, activity);
        //false动画重复
        lunchAdapter.isFirstOnly(false);
        //设置那种动画
        lunchAdapter.openLoadAnimation(BaseQuickAdapter.ALPHAIN);
