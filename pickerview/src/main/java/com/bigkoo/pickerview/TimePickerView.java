...
public class TimePickerView extends BasePickerView implements View.OnClickListener {
    ...
    public Button btnSubmit, btnCancel; //确定、取消按钮
    ...
    public static class Builder {
        ...
        private int Size_Title = 16;//标题字体大小
        ...
        private boolean cancelable = false;//是否能取消
    ...
    private void initView(Context context) {
        ...
        if (customListener == null) {
            ...
            //设置文字颜色
            btnSubmit.setTextColor(Color_Submit == 0 ? pickerview_timebtn_pre : Color_Submit);
